...
* **참조형(Reference Type)**
    * `Student student1`, `int[] students`와 같이 데이터에 접근하기 위한 참조(주소)를 저장하는 데이터 타입을 **"참조형"** 이라고 합니다.
...
**기본형 vs 참조형 - 기본**
* **"기본형"** 은 숫자 `10`, `20`과 같이 실제 사용하는 값을 변수에 담을 수 있습니다.
